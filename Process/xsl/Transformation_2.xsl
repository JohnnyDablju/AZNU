...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      <schema location="../BPELProcess.wsdl"/>
      <rootElement name="CarriageRequest" namespace="http://www.example.org/assistance"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 130301.0647.0008) AT [THU FEB 23 12:15:50 PST 2017]. -->
?>
